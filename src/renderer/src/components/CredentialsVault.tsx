      ...
      <motion.div className="cmdk-backdrop" onClick={onClose}
        ...
        <motion.div className="vault" onClick={(e) => e.stopPropagation()}
          ...
          <div className="vault-body">
            ...
            <section className="vault-card">
              <div className="vault-card-h">
                <span className="vault-ic">🗂️</span> Google Workspace
            ...
            <section className="vault-card">
              <div className="vault-card-h">
                <span className="vault-ic">🛡️</span> Proton Mail (Bridge)
            ...
            <section className="vault-card">
              <div className="vault-card-h"><span className="vault-ic">🎨</span> Creative APIs <span className="vault-badge off">env file</span></div>
              <div className="vault-steps">
          ...
          <div className="vault-foot">
            🔒 Every value is written by the main process to <code>~/.config/dai/*.json</code> at <code>chmod 600</code>. Claude never receives, stores, or transmits them.
